...
import (
	...
	app "github.com/jvveiga/tests-arch-hexagonal/app"
)
...
func (m *MockProductInterface) GetStatus() int8 {
	m.ctrl.T.Helper()
...
func (m *MockProductServiceInterface) Create(name string, price float32) (app.ProductInterface, error) {
	m.ctrl.T.Helper()
